...
abstract class AppLocalizations {
  ...
  /// No description provided for @joinUsToStartPlanning.
  ///
  /// In en, this message translates to:
  /// **'Join us to start planning'**
  ...
  /// No description provided for @travelPlannerWelcome.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @footerPhoneNumber.
  ///
  /// In en, this message translates to:
  /// **'+1 (555) 123-4567'**
  ...
  /// No description provided for @footerOwnerCreator.
  ///
  /// In en, this message translates to:
  /// **'Wanderly Team'**
  ...
  /// No description provided for @pleaseEnterTripTitle.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @toast_accountCreated.
  ///
  /// In en, this message translates to:
  /// **'Account created successfully!'**
  String get toast_accountCreated;

  /// No description provided for @toast_signUpFailed.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @toast_unexpectedError.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @discoverNewPlaces.
  ///
  /// In en, this message translates to:
  /// **'Discover new places'**
