...
class ThemeManager extends ChangeNotifier {
  ...
  Future<void> initialize() async {
    try {
      ...
      AppLogger.getLogger('ThemeManager').warning('Error initializing theme manager: $e');
  ...
  Future<void> setThemeMode(AppThemeMode mode) async {
    try {
      ...
      AppLogger.getLogger('ThemeManager').warning('Error setting theme mode: $e');
      throw StorageException('Failed to set theme', e.toString());
    }
  }
