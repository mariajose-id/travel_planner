...
class LanguageManager extends ChangeNotifier {
  ...
  Future<void> initialize() async {
    try {
      ...
      AppLogger.getLogger('LanguageManager').warning('Error initializing language manager: $e');
  ...
  Future<void> setLanguage(AppLanguage language) async {
    try {
      ...
      AppLogger.getLogger('LanguageManager').warning('Error setting language: $e');
      throw StorageException('Failed to set language', e.toString());
    }
  }
  void toggleLanguage() {
